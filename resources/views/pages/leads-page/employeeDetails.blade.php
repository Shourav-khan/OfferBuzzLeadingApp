                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="card border-0 py-5">
                                            ...
                                            <div class="card-body text-center">
                                                <h5 class="card-title text-muted fs-5">{{$lead->company_name}}</h5>
                                            ...
                                            <div class="col-12 border" >
                                                <div class="container">
                                                    ...
                                                    <div class="container row py-4">
                                                        ...
                                                        @foreach($lead->leadAdditionals as $additional)

                                                            <div class="row">
                                                                <div class="col-xxl-3 col-md-6 col-xl-6">
                                                                    <div class="row my-2">
                                                                        <span>Branch</span>
                                                                        <span>{{ $additional->branch }}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xxl-3 col-md-6 col-xl-6">
                                                                    <div class="row">
                                                                ...
                                                                <div class="col-xxl-3 col-md-6 col-xl-6">
                                                                    <div class="row">
                                                                        <span>phone</span>
                                                                        <span>{{ $additional->phone_number }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
