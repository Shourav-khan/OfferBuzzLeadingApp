            ...
            <div class="col-xxl-10 col-xl-9">
                ...
                <div class="row justify-content-start pe-xxl-4 pe-xl-4">
                    ...
                    <div class="col-xxl-12 my-1 rounded-1" style="background: #FFFFFF">
                        <div class=" mx-2 my-3" >
                            <form class="row g-3 p-2" action="{{route('companies.store')}}" method="POST">
                                @csrf
                                <div class="col-xxl-12 col-xl-6">
                                    <label for="inputEmail4" class="form-label font-style fs-5 text-muted">Owner Name</label>
                                    <input type="text" class="form-control" name="owner_name" id="inputEmail4" placeholder="Write the project title">
                                </div>

                                <div class="col-xxl-6 col-xl-6">
                                    <label for="inputEmail4" class="form-label font-style fs-5 text-muted">Owner Designation</label>
                                    <input type="text" class="form-control" name="owner_designation" id="inputEmail4" placeholder="Write the project title">
                                </div>

                                <div class="col-xxl-6 col-xl-6">
                                    <label for="inputEmail4" class="form-label font-style fs-5 text-muted">Company Name</label>
                                    <input type="text" class="form-control" name="company_name" id="inputEmail4" placeholder="Write the Location">
                                </div>
                                <div class="col-xxl-6 col-xl-6">
                                    <label for="inputEmail4" class="form-label font-style fs-5 text-muted">Phone</label>
                                    <input type="text" class="form-control" name="phone" id="inputEmail4" placeholder="Write the target">
                                </div>
                                <div class="col-xxl-6 col-xl-6">
                                    <label for="inputEmail4" class="form-label font-style fs-5 text-muted">Email</label>
                                    <input type="text" class="form-control" name="email" id="inputEmail4" placeholder="">
                                </div>

                                <div class="col-xxl-6 col-xl-6">
                                    <label for="inputEmail4" class="form-label font-style fs-5 text-muted">GSTIN</label>
                                    <input type="text" class="form-control" name="gstin" id="inputEmail4" placeholder="">
                                </div>
                                ...
                                <div class="col-xxl-6 col-xl-6">
                                    ...
                                    <select class="form-select" multiple="multiple" name="business_id[]" aria-label="Default select example">
                                ...
                                <div class="col-xxl-6 col-xl-6">
                                    ...
                                    <select class="form-select" name="company_status_id" aria-label="Default select example">
                                ...
                                <div class="col-xxl-6 col-xl-6">
                                    ...
                                    <input type="date" class="form-control" name="member_since" id="inputEmail4">
                                </div>
