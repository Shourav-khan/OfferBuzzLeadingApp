            ...
            <div class="col-xxl-10 col-xl-9">
                ...
                <div class="row container-fluid justify-content-start">
                    ...
                    <div class="col-xxl-12 my-1 rounded-1" style="background: #FFFFFF">
                        <div class=" mx-2 my-3" >
                            <form class="row g-3 p-2" action="{{route('project.update',$project)}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="col-xxl-12 col-xl-12">
                                    <label for="inputEmail4" class="form-label font-style fs-5 text-muted">Project Title</label>
                                    <input type="text" name="title" value="{{$project->title}}" class="form-control" id="inputEmail4" placeholder="Write the project title">
                                </div>
                                ...
                                <div class="col-xxl-6 col-xl-6">
                                    ...
                                    <input type="text"  name="project_targets" value="{{$target->title}}"  class="form-control" id="inputEmail4" placeholder="Write the target">
                                ...
                                <div class="col-xxl-6 col-xl-6">
                                    ...
                                    <input type="date" name="start_date" value="{{$project->start_date}}" class="form-control" id="inputEmail4" placeholder="">
                                </div>
                                <div class="col-xxl-6 col-xl-6">
                                    <label for="inputEmail4" class="form-label font-style fs-5 text-muted">Due Date</label>
                                    <input type="date" name="due_date" value="{{$project->due_date}}" class="form-control" id="inputEmail4">
                                </div>
                                <div class="col-xxl-6 col-xl-6">
...
{{--                                        @endforeach--}}
                                        ...
                                        @if($project->teams)
                                            ...
                                            @foreach($teamss as $team)
                                                @foreach($project->teams as $projectTeam)
                                                    @if($team->id == $projectTeam->id)
                                ...
                                <div class="col-xxl-6 col-xl-6">
                                    ...
                                    <select class="form-select"   name="report_to" multiple="multiple" aria-label="Default select example">
                                        ...
                                        @foreach($users as $man)
                                            <option selected value="{{ $man->id }}">{{ $man->name }}</option>
                                        @endforeach
                                ...
                                <div class="col-12 col-xl-12 text-center">
                                    <button type="submit" class="btn btn-danger" style="width: 100px">Edit</button>
                                </div>
                            </form>
                        </div>
                    </div>
