        ...
        <div class="row" style="background: #F5F5F5; font-family: 'Montserrat', sans-serif">
            ...
            <div class="col-xxl-10 col-xl-9 my-1">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <a href="{{route('project.team',['project'=>$project])}}" class="bi bi-arrow-left fs-2 text-black d-md-none d-lg-none d-xl-block"></a>
                            ...
                            <div class="col-12">
                                <div class="row bg-white shadow-sm">
                                    <div class="col-12" >
                                        <div class="row p-4">
                                            <div class="col-12">
                                                <div class="fs-5 text-center" style="font-weight: 600">Project : {{$project->title}}</div>
                                                <span class="d-flex justify-content-center text-muted" style="font-weight: 500">Location:


{{--                                                    @foreach($team->territory as $teamTerri)--}}
...
{{--                                                    @endforeach--}}
                                            ...
                                            <div class="col-12">
                                                <div class="row fs-6 text-muted" style="font-weight: 500">
                                                    <div class="col-6 ">
                                                        <div >Start Date:{{$project->created_at}}</div>
                                                        <span>Due Date:11/05/22</span>
                                                    </div>
                                                    <div class="col-6 text-end">
                                                        <div >Target:

                                                            @foreach($project->projectTargets as $projectTarget)
                                                                {{$projectTarget->title}}
                                                            @endforeach
                                                                                    ...
                                                                                    <div class="col-xxl-12">
                                                                                        <div class="row my-3 mx-3">
                                                                                            <div class="col-xxl-6 col-md-12 col-lg-6">
                                                                                                <div class="col-4 text-danger" style="font-weight: 500"><a href="#" style="text-decoration: none; color: #CB0E00">Edit</a></div>
                                                                                            </div>
                                                                                            <div class="col-xxl-6 col-md-12 col-lg-6">
                                                                                                <div class="col-4 text-danger" style="font-weight: 500"><a href="#" style="text-decoration: none; color: #CB0E00">View</a></div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
